...
public class MetadataExportServlet extends DSpaceServlet
{
    ...
    {
    	log.info("Get metadata export servlet");
        // Get the handle requested for the export
        String handle = request.getParameter("handle");
        log.info("handle is: " + handle);
        ...
        if (handle != null)
        {
            ...
            if (thing != null)
            {
                ...
                {
                	log.info("Before exporter");
//                	if (exporter.)
                	Community community = (Community)thing;
                	community.canEdit();
                    exporter = new MetadataExport(context, community, false);
//                    exporter = new MetadataExport(context, (Community)thing, false);
                    log.info("After exporter");
                }
