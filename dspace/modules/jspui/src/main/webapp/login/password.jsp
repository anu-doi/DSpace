...
<anu:content layout="one-third">
	<anu:box backgroundColour="grey" backgroundOpacity="10">
		...
		<a href="http://openresearch.anu.edu.au/files/guidance/160510%20Submitting%20an%20item%20to%20the%20Open%20Research%20repository.pdf">Submitting an item to the Open Research repository (PDF, 397.97KB)</a>
	</anu:box>
	<anu:box backgroundColour="grey" backgroundOpacity="10">
		<h2>Contact</h2>
