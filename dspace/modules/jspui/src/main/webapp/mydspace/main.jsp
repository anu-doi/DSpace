...
<%
	...
	// Provide some form of sorting for the workflow items
    Comparator<WorkflowItem> workflowComparator = new Comparator<WorkflowItem>() {
		@Override
		public int compare(WorkflowItem workflowItem1, WorkflowItem workflowItem2) {
			int i = 0;
			i = workflowItem1.getCollection().getName().compareTo(workflowItem2.getCollection().getName());
			if(i != 0) {
				return i;
			}
			i = workflowItem2.getItem().getLastModified().compareTo(workflowItem1.getItem().getLastModified());
			if(i != 0) {
				return i;
			}
	...
	Arrays.sort(workflowItems, workflowComparator);
	Arrays.sort(owned, workflowComparator);
	Arrays.sort(pooled, workflowComparator);
