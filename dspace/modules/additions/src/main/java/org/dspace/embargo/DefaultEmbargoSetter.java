...
public class DefaultEmbargoSetter implements EmbargoSetter
{
        ...
        throws SQLException, AuthorizeException, IOException
    {
        ...
        {
            // Skip the LICENSE, METADATA, THUMBNAIL and BRANDED_PREVIEW bundles, they stay world-readable
            String bnn = bn.getName();
            if (!(bnn.equals(Constants.LICENSE_BUNDLE_NAME) || bnn.equals(Constants.METADATA_BUNDLE_NAME) || bnn.equals(CreativeCommons.CC_BUNDLE_NAME) || bnn.equals("THUMBNAIL") || bnn.equals("BRANDED_PREVIEW")))
            {
