...
public class XMLtoBio extends Converter {
    ...
    protected String RECORD = "//record:record";
    
//    protected String ORCID_BIO = "//person:person";

//    protected String ORCID = "parent::*/orcid";
    protected String ORCID = "common:orcid-identifier/common:path";

    protected String PERSON = "person:person";
    protected String PERSONAL_DETAILS = PERSON + "/person:name";
    protected String GIVEN_NAMES = PERSONAL_DETAILS + "/personal-details:given-names";
    protected String FAMILY_NAME = PERSONAL_DETAILS + "/personal-details:family-name";
//    protected String CREDIT_NAME = PERSONAL_DETAILS + "/credit-name";
//    protected String OTHER_NAMES = PERSONAL_DETAILS + "/other-name:other-names";
