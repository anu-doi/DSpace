...
public class StatisCollectionDataDownloads extends StatisticsData {
	...
	public StatisCollectionDataDownloads() {
		super();
	}

	public StatisCollectionDataDownloads(DSpaceObject dso) {
		super();
		this.currentDso = dso;
	}

	public StatisCollectionDataDownloads(DSpaceObject dso, String author) {
		super();
		this.currentDso = dso;
	}
