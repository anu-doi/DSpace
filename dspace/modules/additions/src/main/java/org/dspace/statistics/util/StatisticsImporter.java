...
//                uuid = parts[0];
                ...
                user = parts[4];
                ip = parts[5];
                if ("archive_item".equals(action)) {
                	workflowItemId = parts[6];
                }
                ...
                else if ("view_item".equals(action) || "archive_item".equals(action))
                {
                    type = Constants.ITEM;
                    if (useLocal)
                    {
                ...
                if (epersonId > 0 && !"archive_item".equals(action))
                {
