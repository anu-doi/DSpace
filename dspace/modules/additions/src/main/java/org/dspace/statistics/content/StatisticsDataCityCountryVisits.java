 ...
 * Time: 12:25:20
 */
public class StatisticsDataCityCountryVisits extends StatisticsData {
    /**
     ...
     */
    public StatisticsDataCityCountryVisits() {
        super();
    }
     ...
     */
    public StatisticsDataCityCountryVisits(DSpaceObject dso) {
        super();
        this.currentDso = dso;
    }
     ...
     */
    public StatisticsDataCityCountryVisits(DSpaceObject currentDso, Dataset dataset) {
        super(dataset);
     ...
     * @param dataset the target dataset
     */
    public StatisticsDataCityCountryVisits(Dataset dataset) {
        super(dataset);
    }
...
//                System.out.println("BOTH");
    ...
    protected void processAxis(Context context, DatasetGenerator datasetGenerator, List<DatasetQuery> queries)
        ...
        if (datasetGenerator instanceof DatasetDSpaceObjectGenerator) {
            ...
            Query query = new Query();
            if (currentDso != null) {
                query.setDso(currentDso, Constants.ITEM);
            }
            datasetQuery.addQuery(query);
            // Then add the rest
