...
public class JPEGFilter extends MediaFilter implements SelfRegisterInputFormats {
    ...
    public InputStream getThumbDim(Item currentItem, BufferedImage buf, boolean verbose, int xmax, int ymax,
        ...
        BufferedImage thumbnail = new BufferedImage(xsize, ysize + brandHeight, BufferedImage.TYPE_INT_RGB);
        ...
        if (blurring) {
        	...
        	try {
        		BufferedImage tmp = getBlurredInstance((BufferedImage) correctedImage);
        		correctedImage = tmp;
        ...
        if (hqscaling) {
        	...
        	try {
        		BufferedImage tmp = getScaledInstance((BufferedImage) correctedImage, (int) xsize, (int) ysize,
