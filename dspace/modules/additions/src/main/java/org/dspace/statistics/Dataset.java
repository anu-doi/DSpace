...
/**
 * @author kevinvandevelde at atmire.com Date: 21-Jan-2009 Time: 13:44:48
 */
public class Dataset {
	...
	public ByteArrayOutputStream exportAsCSV() throws IOException {
		...
		ICSVWriter ecsvp = new CSVWriterBuilder(new OutputStreamWriter(baos, StandardCharsets.UTF_8)).withSeparator(',')
				.build();
